...
class Edit extends Action
{
    ...
    /**
     * @var \Crocoit\Post\Model\Department
     */
    protected $_model;
     ...
     * @param \Crocoit\Post\Model\Department $model
     */
    public function __construct(
        Action\Context $context,
        \Magento\Framework\View\Result\PageFactory $resultPageFactory,
        \Magento\Framework\Registry $registry,
        \Crocoit\Post\Model\Department $model
    ) {
    ...
    {
        return $this->_authorization->isAllowed('Crocoit_Post::department_save');
    }
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('crocoit_department', $model);
